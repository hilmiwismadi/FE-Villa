          ...
          <div className="lg:col-span-2">
            <div className="bg-white p-8 shadow-sm">
              ...
              <p className="text-sm text-primary-600 mb-4">
                {t.booking.calendar.instruction}
              </p>
              <Calendar
                multiSelect
              ...
              {derivedCheckIn && derivedCheckOut && (
                <div className="mt-6 p-4 bg-primary-50 border border-primary-200">
                  <p className="text-sm text-primary-700">
                    <strong>{t.booking.calendar.checkIn}:</strong> {derivedCheckIn.toLocaleDateString(dateFnsLocale.code === 'id' ? 'id-ID' : 'en-US', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}
                  </p>
                  <p className="text-sm text-primary-700 mt-2">
                    <strong>{t.booking.calendar.checkOut}:</strong> {derivedCheckOut.toLocaleDateString(dateFnsLocale.code === 'id' ? 'id-ID' : 'en-US', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}
                  </p>
                  <p className="text-sm text-primary-700 mt-2">
                    <strong>{t.booking.calendar.numberOfNights}:</strong> {numberOfNights}
                  </p>
                </div>
              )}
            </div>
                ...
                {derivedCheckIn && derivedCheckOut ? (
                  <>
                    <div className="flex justify-between text-primary-700">
                      <span>IDR {basePrice.toLocaleString()} × {numberOfNights} {nightLabel}</span>
