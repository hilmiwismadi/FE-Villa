      ...
      <div className="container-custom max-w-3xl">
        <div className="bg-white p-8 md:p-12 shadow-sm text-center">
          ...
          <p className="text-lg text-primary-700 mb-8">
            {t.booking.confirmation.referenceIntro}
          </p>
          ...
          <div className="mb-10">
            ...
            >
              ...
              {t.booking.confirmation.confirmWhatsApp}
            </button>
            <button
            ...
            >
              ...
              {linkCopied ? t.booking.confirmation.linkCopied : t.booking.confirmation.saveLink}
            </button>
          </div>

          <div className="text-left bg-primary-50 p-6 mb-8">
            <h2 className="text-xl font-serif text-primary-900 mb-4">{t.booking.confirmation.whatNextTitle}</h2>
            <ol className="space-y-3 text-primary-700">
              <li className="flex gap-3">
                ...
                <span>
                  <strong>{t.booking.confirmation.step1Title}</strong> {t.booking.confirmation.step1Text}
                </span>
              </li>
              <li className="flex gap-3">
                <span className="flex-shrink-0 w-6 h-6 bg-gold-600 text-white rounded-full flex items-center justify-center text-sm font-semibold">
                ...
                <span>
                  <strong>{t.booking.confirmation.step2Title}</strong> {t.booking.confirmation.step2Text}
                </span>
              </li>
              <li className="flex gap-3">
                <span className="flex-shrink-0 w-6 h-6 bg-gold-600 text-white rounded-full flex items-center justify-center text-sm font-semibold">
                ...
                <span>
                  <strong>{t.booking.confirmation.step3Title}</strong> {t.booking.confirmation.step3Text}
                </span>
              </li>
            </ol>
          </div>
          ...
          <div className="bg-blue-50 border border-blue-200 p-4 mb-8">
            <p className="text-sm text-blue-800">
              <strong>Important:</strong> {t.booking.confirmation.importantNote.replace('{bookingId}', bookingId || '')}
            </p>
          </div>
          ...
          <div className="mt-12 pt-8 border-t border-primary-200">
            <h3 className="text-lg font-serif text-primary-900 mb-3">{t.booking.confirmation.needHelp}</h3>
            <p className="text-sm text-primary-700">
              {t.booking.confirmation.needHelpText}
            </p>
            <div className="mt-3 text-sm text-primary-700">
              <p>{t.booking.confirmation.email}</p>
              <p>{t.booking.confirmation.phone}</p>
            </div>
          </div>
        </div>
      </div>
